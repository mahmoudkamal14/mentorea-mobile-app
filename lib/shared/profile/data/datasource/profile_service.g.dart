...
class _ProfileService implements ProfileService {
  ...
  Future<MenteeProfileResponseModel> getMenteeProfile(String userToken) async {
    ...
    final _options = _setStreamType<MenteeProfileResponseModel>(
  ...
  @override
  Future<MentorProfileResponseModel> getMentorProfile(String userToken) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': userToken};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MentorProfileResponseModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/me/mentor',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MentorProfileResponseModel _value;
    try {
      _value = MentorProfileResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
