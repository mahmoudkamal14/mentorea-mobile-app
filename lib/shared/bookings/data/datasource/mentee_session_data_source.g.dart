...
class _MenteeSessionDataSource implements MenteeSessionDataSource {
  _MenteeSessionDataSource(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<SessionResponseModel> createSession(
    ...
    final _options = _setStreamType<SessionResponseModel>(
  ...
  Future<void> giveSessionFeedback(
    GiveFeedbackRequestBody giveFeedbackRequestBody,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
