...
class _CommunityPostRemoteDataSource implements CommunityPostRemoteDataSource {
  _CommunityPostRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<PostResponseModel> createPost(
    ...
    final _options = _setStreamType<PostResponseModel>(
  ...
  @override
  Future<void> deletePost(String userToken, String postId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': userToken};
    _headers.removeWhere((k, v) => v == null);
  ...
  Future<PostsListResponseModel> getAllPosts(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PostsListResponseModel>(
