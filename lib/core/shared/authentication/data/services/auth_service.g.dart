...
class _AuthServices implements AuthServices {
  ...
  Future<void> registerFcmToken(
      RegisterFcmRequestBody registerFcmRequestBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(registerFcmRequestBody.toJson());
  ...
  @override
  Future<List<FieldResponseModel>> getAllFields() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<FieldResponseModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<FieldResponseModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
