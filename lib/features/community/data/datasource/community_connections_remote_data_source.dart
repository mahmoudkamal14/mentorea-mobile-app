...
import 'package:mentorea_mobile_app/features/community/data/model/connection/toggle_follow_request_body.dart';
...
abstract class CommunityConnectionsRemoteDataSource {
  factory CommunityConnectionsRemoteDataSource(
    Dio dio, {
    String baseUrl,
