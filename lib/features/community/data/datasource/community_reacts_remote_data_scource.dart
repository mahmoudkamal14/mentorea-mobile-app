...
import 'package:mentorea_mobile_app/features/community/data/model/react/comments_list_response_model.dart';
import 'package:mentorea_mobile_app/features/community/data/model/react/create_comment_request_body.dart';
import 'package:mentorea_mobile_app/features/community/data/model/react/toggle_like_request_body.dart';
import 'package:mentorea_mobile_app/features/community/data/model/post/users_liked_post_response_model.dart';
...
abstract class CommunityReactsRemoteDataScource {
  factory CommunityReactsRemoteDataScource(Dio dio,
      {String baseUrl,
      ParseErrorLogger? errorLogger}) = _CommunityReactsRemoteDataScource;
